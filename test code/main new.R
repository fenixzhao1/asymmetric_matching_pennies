...
# create round variable in choice data
...
for(i in 1:length(uniquePairs)){
  ...
  for(j in 1:length(pairRounds)){
    ...
    plot(pairRoundData$tick, pairRoundData$p1_strategy, main="player 1", xlab = "time", ylab = "strategy")
    plot(pairRoundData$tick, pairRoundData$p2_strategy, main="player 2", xlab = "time", ylab = "strategy")
    # plot(pairRoundData$tick, pairRoundData$p1_payoff, main="player 1", xlab = "time", ylab = "payoff")
    # plot(pairRoundData$tick, pairRoundData$p2_payoff, main="player 2", xlab = "time", ylab = "payoff")   
    dev.off()
