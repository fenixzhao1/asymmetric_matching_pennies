...
**********Regressions of cycles by pair**********
* open dataset
use "/Users/fenix/Dropbox/GSR/Continuous Bimatrix/Matching pennies/stata/mp_pairwise_paircycles.dta", clear

* create treatment dummies
gen dummy_8002 = 0
replace dummy_8002 = 1 if game=="8002"

gen dummy_continuous = 0
replace dummy_continuous = 1 if time=="continuous"

gen dummy_pure = 0
replace dummy_pure = 1 if strategy=="pure"
...
* run multinomial logistic
xi:mlogit type dummy_continuous dummy_pure dummy_8002 dummy_continuous_pure dummy_continuous_8002 ///
               dummy_pure_8002 dummy_continuous_pure_8002 baseoutcome(3) 
outreg2 using C:\Users\fenix\Dropbox\stataresult, tex nonote se replace nolabel bdec(2)

* run one vs all regression
reg CW dummy_continuous dummy_pure dummy_8002 dummy_continuous_pure ///
       dummy_continuous_8002 dummy_pure_8002 dummy_continuous_pure_8002
outreg2 using C:\Users\fenix\Dropbox\stataresult, tex nonote se replace nolabel bdec(2)

reg CCW dummy_continuous dummy_pure dummy_8002 dummy_continuous_pure ///
       dummy_continuous_8002 dummy_pure_8002 dummy_continuous_pure_8002
outreg2 using C:\Users\fenix\Dropbox\stataresult, tex nonote se append nolabel bdec(2)

reg diagonal dummy_continuous dummy_pure dummy_8002 dummy_continuous_pure ///
       dummy_continuous_8002 dummy_pure_8002 dummy_continuous_pure_8002
outreg2 using C:\Users\fenix\Dropbox\stataresult, tex nonote se append nolabel bdec(2)

reg stay dummy_continuous dummy_pure dummy_8002 dummy_continuous_pure ///
       dummy_continuous_8002 dummy_pure_8002 dummy_continuous_pure_8002
outreg2 using C:\Users\fenix\Dropbox\stataresult, tex nonote se append nolabel bdec(2)
